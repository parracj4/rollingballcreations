          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              {state.items.map((item) => (
                <GlassCard key={item.sculpture.id} className="flex gap-6 p-4" hover={false}>
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-white font-semibold mb-1">{item.sculpture.material}</h3>
              ...
              <Link href="/gallery" className="inline-flex items-center gap-2 text-text-secondary hover:text-white transition-colors mt-4">
                ← Continue Shopping
              </Link>
            </div>
            ...
            <div>
              <GlassCard className="sticky top-32" hover={false}>
                ...
                <GlassButton onClick={handleCheckout} variant="primary" size="lg" className="w-full" disabled={isProcessing}>
